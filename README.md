...
A Grafana visualization is avalable [here](https://udl.grafana.net/d/bMRdlVaWz/skyspark?orgId=1&from=1576273851405&to=1576878651405&panelId=2&fullscreen). However, the data values are stored as strings and Grafana can only visulaze the aggregated values such as `count`.
